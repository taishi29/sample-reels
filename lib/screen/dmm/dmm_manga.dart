...
class DmmMangaPageState extends State<DmmMangaPage> {
  List<bool> isLikedList = []; // 各マンガごとの「いいね」状態
  List<int> likeCountList = []; // 各マンガごとの「いいね」数
  List<List<String>> _mangaUrls = []; // Firestore から取得するページ画像
          ...
          return Stack(
            children: [
              ...
              RightSideButtons(
                ...
                isLiked: isLikedList[index], // ✅ 各マンガの状態を参照
                likeCount: likeCountList[index], // ✅ 各マンガの like 数を参照
